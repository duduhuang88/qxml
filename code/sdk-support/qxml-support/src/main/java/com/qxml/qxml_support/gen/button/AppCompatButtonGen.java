...
public class AppCompatButtonGen extends ButtonGen implements TextViewAutoSizeAttr {
    ...
    public void onTextViewFontFamily(TextView textView) {
        if (__compatButtonLocalVar.finalFontFamilyId != 0 || __textViewLocalVar.fontFamily != null) {
            com.qxml.qxml_support.gen.textView.TextViewGenHelper.setCompatFontFamily(__context, ___typedValue, __compatButtonLocalVar.finalFontFamilyId, __textViewLocalVar.fontFamily, textView, __textViewLocalVar.textStyle, __textViewLocalVar.textFontWeight);
        } else {
