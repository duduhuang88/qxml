    ...
    public void onSpinnerThemeEnd(Spinner spinner) {
        ...
        if (__spinnerLocalVar.spinnerMode == 0) {
            ...
            if (__spinnerLocalVar.dropDownSelector != 0) {
                ...
                com.qxml.qxml_androidx.gen.spinner.SpinnerHelper.setAttr(spinner, __context, __spinnerLocalVar.dropDownSelector);
            }
        }
        ...
        if (__spinnerLocalVar.entriesId != 0) {
            com.qxml.qxml_androidx.gen.spinner.SpinnerHelper.setDefaultAdapter(spinner, __context, __spinnerLocalVar.entriesId);
        }
    }
}
