package com.qxml.qxml_androidx.gen.recyclerView;
...
public class RecyclerViewGen extends ViewGroupGen {
    ...
    public void onRecyclerViewManagerEnd(RecyclerView recyclerView) {
        if (__recyclerViewLocalVar.layoutManager != null) {
            if ("androidx.recyclerview.widget.GridLayoutManager".equals(__recyclerViewLocalVar.layoutManager) || "GridLayoutManager".equals(__recyclerViewLocalVar.layoutManager)) {
                androidx.recyclerview.widget.GridLayoutManager gridLayoutManager = new androidx.recyclerview.widget.GridLayoutManager(__context, __recyclerViewLocalVar.spanCount, __recyclerViewLocalVar.managerOrientation, __recyclerViewLocalVar.reverseLayout);
                recyclerView.setLayoutManager(gridLayoutManager);
            } else if ("androidx.recyclerview.widget.LinearLayoutManager".equals(__recyclerViewLocalVar.layoutManager) || "LinearLayoutManager".equals(__recyclerViewLocalVar.layoutManager)) {
                androidx.recyclerview.widget.LinearLayoutManager linearLayoutManager = new androidx.recyclerview.widget.LinearLayoutManager(__context, __recyclerViewLocalVar.managerOrientation, __recyclerViewLocalVar.reverseLayout);
                linearLayoutManager.setStackFromEnd(__recyclerViewLocalVar.stackFromEnd);
                recyclerView.setLayoutManager(linearLayoutManager);
            } else if ("androidx.recyclerview.widget.StaggeredGridLayoutManager".equals(__recyclerViewLocalVar.layoutManager) || "StaggeredGridLayoutManager".equals(__recyclerViewLocalVar.layoutManager)) {
                androidx.recyclerview.widget.StaggeredGridLayoutManager staggeredGridLayoutManager = new androidx.recyclerview.widget.StaggeredGridLayoutManager(__recyclerViewLocalVar.spanCount, __recyclerViewLocalVar.managerOrientation);
                recyclerView.setLayoutManager(staggeredGridLayoutManager);
            } else {
                androidx.recyclerview.widget.RecyclerView.LayoutManager layoutManager = com.qxml.qxml_androidx.gen.recyclerView.RecyclerViewHelper.createLayoutManager(__context, __recyclerViewLocalVar.layoutManager);
    ...
    public void onRecyclerViewFastScrollEnd(RecyclerView recyclerView) {
        if (__recyclerViewLocalVar.fastScrollEnabled) {
            com.qxml.qxml_androidx.gen.recyclerView.RecyclerViewHelper.initFastScroller(recyclerView, __context, ___resources
