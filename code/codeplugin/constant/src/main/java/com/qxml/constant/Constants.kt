...
class Constants {
    ...
    companion object {
        ...
        const val GEN_MODEL_CACHE_DIR = "genModelInfo"
        const val MERGE_XML_CACHE_DIR_NAME = "mergeXmlCache"
        const val QXML_INIT_CONTENT_DIR = "initContent"
        const val QXML_INIT_CONTENT_CACHE_FILE = "initContent.txt"
        ...
        const val QXML_STYLE_CACHE_DIR_NAME = "style"
        ...
        const val MERGER_XML = "merger.xml"
