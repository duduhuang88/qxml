...
public class DraweeViewGen extends ImageViewGen implements ConstrainAttr {
    ...
    public void draweeViewPlaceholderImageScaleType(DraweeView draweeView, int placeholderImageScaleType) {
        __draweeViewLocalVar.builder.setPlaceholderImageScaleType(com.qxml.qxml_androidx.gen.fresco.FrescoHelper.getScaleTypeFromXml(placeholderImageScaleType));
    }
    ...
    public void draweeViewRetryImageScaleType(DraweeView draweeView, int retryImageScaleType) {
        __draweeViewLocalVar.builder.setRetryImageScaleType(com.qxml.qxml_androidx.gen.fresco.FrescoHelper.getScaleTypeFromXml(retryImageScaleType));
    }
    ...
    public void draweeViewFailureImageScaleType(DraweeView draweeView, int failureImageScaleType) {
        __draweeViewLocalVar.builder.setFailureImageScaleType(com.qxml.qxml_androidx.gen.fresco.FrescoHelper.getScaleTypeFromXml(failureImageScaleType));
    }
    ...
    public void draweeViewProgressBarImageScaleType(DraweeView draweeView, int progressBarImageScaleType) {
        __draweeViewLocalVar.builder.setProgressBarImageScaleType(com.qxml.qxml_androidx.gen.fresco.FrescoHelper.getScaleTypeFromXml(progressBarImageScaleType));
    }
    ...
    public void draweeViewActualImageScaleType(DraweeView draweeView, int actualImageScaleType) {
        __draweeViewLocalVar.builder.setActualImageScaleType(com.qxml.qxml_androidx.gen.fresco.FrescoHelper.getScaleTypeFromXml(actualImageScaleType));
    }
