...
public class TabLayoutGen extends HorizontalScrollViewGen {
    ...
    public void onTabLayoutTabIndicatorColor(TabLayout tabLayout, ValueInfo valueInfo) {
        if (valueInfo.isColor()) {
            ...
            tabLayout.setSelectedTabIndicatorColor(androidx.core.content.ContextCompat.getColor(__context, valueInfo.resourceId));
        }
    }
    ...
    public void onTabLayoutTabBackground(TabLayout tabLayout, int tabBackground) {
        com.qxml.qxml_androidx.gen.tabLayout.TabLayoutHelper.setTabBackgroundResId(tabLayout, tabBackground);
    }
    ...
    public void onTabLayoutTabMinWidth(TabLayout tabLayout, int tabMinWidth) {
        com.qxml.qxml_androidx.gen.tabLayout.TabLayoutHelper.setRequestedTabMinWidthField(tabLayout, tabMinWidth);
    }

    @Attr(RS.attr.tabMaxWidth)
    public void onTabLayoutTabMaxWidth(TabLayout tabLayout, int tabMaxWidth) {
        com.qxml.qxml_androidx.gen.tabLayout.TabLayoutHelper.setRequestedTabMaxWidthField(tabLayout, tabMaxWidth);
    }
    ...
    public void onTabLayoutTabTextAppearance(TabLayout tabLayout, int styleId) {
        ...
        com.qxml.qxml_androidx.gen.tabLayout.TabLayoutHelper.setTabTextSizeField(tabLayout, textSize);
        if (__tabLayoutLocalVar.colorStateList == null) {
            __tabLayoutLocalVar.colorStateList = com.google.android.material.resources.MaterialResources.getColorStateList(__context, typedArray, 1);
        }
        typedArray.recycle();
    }
    ...
    public void onTabLayoutTabTextColor(TabLayout tabLayout, ValueInfo tabTextColor) {
        if (tabTextColor.isColor()) {
            ...
            __tabLayoutLocalVar.colorStateList = androidx.appcompat.content.res.AppCompatResources.getColorStateList(__context, tabTextColor.resourceId);
        }
    }
    ...
    public void onTabLayoutTabSelectedTextColor(TabLayout tabLayout, ValueInfo tabSelectedTextColor) {
        if (tabSelectedTextColor.isColor()) {
            ...
            __tabLayoutLocalVar.tabSelectedTextColorValue = androidx.core.content.ContextCompat.getColor(__context, tabSelectedTextColor.resourceId);
        }
    }
    ...
    public void onTabLayoutTabIconTint(TabLayout tabLayout, ValueInfo tabIconTint) {
        if (tabIconTint.isColor()) {
            ...
            tabLayout.setTabIconTint(androidx.appcompat.content.res.AppCompatResources.getColorStateList(__context, tabIconTint.resourceId));
        }
    }

    @Attr(RS.attr.tabIconTintMode)
    public void onTabLayoutTabIconTintMode(TabLayout tabLayout, int tabIconTintMode) {
        com.qxml.qxml_androidx.gen.tabLayout.TabLayoutHelper.setTabIconTintModeFieldField(tabLayout, tabIconTintMode);
    }
    ...
    public void onTabLayoutTabRippleColor(TabLayout tabLayout, ValueInfo tabRippleColor) {
        if (tabRippleColor.isColor()) {
            ...
            tabLayout.setTabRippleColor(androidx.appcompat.content.res.AppCompatResources.getColorStateList(__context, tabRippleColor.resourceId));
        }
    }
    ...
    public void onTabLayoutTabIndicatorAnimationDuration(TabLayout tabLayout, int tabIndicatorAnimationDuration) {
        com.qxml.qxml_androidx.gen.tabLayout.TabLayoutHelper.setTabIndicatorAnimationDurationField(tabLayout, tabIndicatorAnimationDuration);
    }
    ...
    public void onTabLayoutTabModeEnd(TabLayout tabLayout) {
        if (__tabLayoutLocalVar.tabPaddingStart != 0) com.qxml.qxml_androidx.gen.tabLayout.TabLayoutHelper.setTabPaddingStartField(tabLayout, __tabLayoutLocalVar.tabPaddingStart);
        if (__tabLayoutLocalVar.tabPaddingTop != 0) com.qxml.qxml_androidx.gen.tabLayout.TabLayoutHelper.setTabPaddingTopField(tabLayout, __tabLayoutLocalVar.tabPaddingTop);
        if (__tabLayoutLocalVar.tabPaddingEnd != 0) com.qxml.qxml_androidx.gen.tabLayout.TabLayoutHelper.setTabPaddingEndField(tabLayout, __tabLayoutLocalVar.tabPaddingEnd);
        if (__tabLayoutLocalVar.tabPaddingBottom != 0) com.qxml.qxml_androidx.gen.tabLayout.TabLayoutHelper.setTabPaddingBottomField(tabLayout, __tabLayoutLocalVar.tabPaddingBottom);
        if (__tabLayoutLocalVar.tabContentStart != 0) com.qxml.qxml_androidx.gen.tabLayout.TabLayoutHelper.setContentInsetStart(tabLayout, __tabLayoutLocalVar.tabContentStart);
