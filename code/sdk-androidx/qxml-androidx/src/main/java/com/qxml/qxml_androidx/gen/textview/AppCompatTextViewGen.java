...
public class AppCompatTextViewGen extends TextViewCompatGen {
    ...
    public void onTextViewFontFamily(TextView textView) {
        if (__compatTextViewLocalVar.finalFontFamilyId != 0 || __textViewLocalVar.fontFamily != null) {
            com.qxml.qxml_androidx.gen.textview.TextViewGenHelper.setCompatFontFamily(__context, ___typedValue, __compatTextViewLocalVar.finalFontFamilyId, __textViewLocalVar.fontFamily, textView, __textViewLocalVar.textStyle, __textViewLocalVar.textFontWeight);
        } else {
