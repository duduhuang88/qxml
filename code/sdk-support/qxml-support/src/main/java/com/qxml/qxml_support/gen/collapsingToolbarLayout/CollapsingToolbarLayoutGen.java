...
@ViewParse(value = CollapsingToolbarLayout.class, layoutParamInit = "new android.support.design.widget.CollapsingToolbarLayout.LayoutParams(-1, -1)")
public class CollapsingToolbarLayoutGen extends FrameLayoutGen {
    ...
    public void collapsingToolbarLayoutToolbarId(CollapsingToolbarLayout collapsingToolbarLayout, int toolbarId) {
        com.qxml.qxml_support.gen.collapsingToolbarLayout.CollapsingToolbarLayoutHelper.setToolbarId(collapsingToolbarLayout, toolbarId);
    }

    @OnEnd({RS.attr.expandedTitleMargin, RS.attr.expandedTitleMarginStart
            , RS.attr.expandedTitleMarginTop, RS.attr.expandedTitleMarginEnd, RS.attr.expandedTitleMarginBottom})
    public void onCollapsingToolbarLayoutExpandedTitleMarginEnd(CollapsingToolbarLayout collapsingToolbarLayout) {
        //collapsingToolbarLayout.setExpandedTitleMargin(__collapsingToolbarLocalVar.expandedMarginStart, __collapsingToolbarLocalVar.expandedMarginTop, __collapsingToolbarLocalVar.expandedMarginEnd, __collapsingToolbarLocalVar.expandedMarginBottom);
    }
