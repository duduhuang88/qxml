package com.qxml.qxml_androidx.gen.toolbar;
...
public class ToolbarGen extends ViewGroupGen {
    ...
    public void viewGravity(View view, int gravityFlag) {
        com.qxml.qxml_androidx.gen.toolbar.ToolbarHelper.setMGravity((androidx.appcompat.widget.Toolbar) view, gravityFlag);
    }

    @Attr(RS.attr.buttonGravity)
    public void toolbarButtonGravity(Toolbar toolbar, int buttonGravity) {
        com.qxml.qxml_androidx.gen.toolbar.ToolbarHelper.setMButtonGravityField(toolbar, buttonGravity);
    }
    ...
    public void toolbarMaxButtonHeight(Toolbar toolbar, int maxButtonHeight) {
        com.qxml.qxml_androidx.gen.toolbar.ToolbarHelper.setMMaxButtonHeightField(toolbar, maxButtonHeight);
    }
    ...
    public void toolbarCollapseIcon(Toolbar toolbar, ValueInfo collapseIcon) {
        com.qxml.qxml_androidx.gen.toolbar.ToolbarHelper.setMCollapseIconField(toolbar, collapseIcon.getReferenceDrawable(__context, ___resources));
    }
    ...
    public void toolbarCollapseContentDescription(Toolbar toolbar, String collapseContentDescription) {
        com.qxml.qxml_androidx.gen.toolbar.ToolbarHelper.setMCollapseDescriptionField(toolbar, collapseContentDescription);
    }
    ...
    @Attr(RS.attr.menu)
    public void toolbarMenu(Toolbar toolbar, int menu) {
