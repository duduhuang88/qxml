package com.qxml.qxml_androidx.gen.textview.attr;
...
public interface TextViewAutoSizeAttr extends ViewLocalVar {
    ...
    default void textViewTextAutoSizePresetSizes(TextView textView, int autoSizePresetSizes) {
        ...
        androidx.core.widget.TextViewCompat.setAutoSizeTextTypeUniformWithPresetSizes(textView, textView.getContext().getResources().getIntArray(autoSizePresetSizes), android.util.TypedValue.COMPLEX_UNIT_PX);
    }
    ...
    default void onTextViewAutoSizeEnd(TextView textView) {
        if (__textViewAutoSizeLocalVar.autoSizeTextType == 1) {
            ...
            androidx.core.widget.TextViewCompat.setAutoSizeTextTypeUniformWithConfiguration(textView, __textViewAutoSizeLocalVar.autoSizeMinTextSize, __textViewAutoSizeLocalVar.autoSizeMaxTextSize, __textViewAutoSizeLocalVar.autoSizeStepGranularity, android.util.TypedValue.COMPLEX_UNIT_PX);
        }
    }
