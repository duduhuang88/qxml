...
public interface ConstrainAttr extends ViewLocalVar {
    ...
    default void onViewConstraintEnd(View view) {
        ...
        if (lp instanceof android.support.constraint.ConstraintLayout.LayoutParams) {
            android.support.constraint.ConstraintLayout.LayoutParams clp = (android.support.constraint.ConstraintLayout.LayoutParams) lp;
